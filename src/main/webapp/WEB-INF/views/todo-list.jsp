        ...
        <div class="container">
            ...
            <form action="/todos.do" method="post">
                <div class="row">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="date" class="form-control" name="endAt" id="endAt" />
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-borderless">
                    ...
                    <% for(Todo todo : todos) { %>
                    <tr>
                        <td class="text-center"><%= todo.getName() %></td>
                        <td class="text-center"><%= todo.getCreatedAt() %></td>
                        <td class="text-center"><%= todo.getEndAt() %></td>
                        <td class="text-center">
                            <a href="/markasdone.do?name=<%=todo.getName()%>">
                                <%= todo.isStatus() ? "<i class='bx bx-check-double'></i>" : "<i class='bx bx-x'></i>"  %>
                            </a>
                        </td>
                        <td class="text-center">
                            <a class="btn btn-warning" href="/update-todo.do?name=<%=todo.getName()%>">Update</a>
                            <a class="btn btn-danger" href="/delete-todo.do?name=<%=todo.getName()%>">Delete</a>
                        </td>
                    </tr>
                    <% } %>
                    </tbody>
